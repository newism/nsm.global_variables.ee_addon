...
class Nsm_global_variables_tab
{
	/**
	...
	public function publish_tabs($channel_id, $entry_id = false)
	{
		...
		// if(!class_exists('Nsm_global_variables_ext'))
		// 	require(PATH_THIRD . "nsm_global_variables/ext.nsm_global_variables.php");
		// 
		// $ext = new Nsm_global_variables_ext();
		// if(
		...
		$EE =& get_instance();
		$EE->lang->loadfile('nsm_global_variables');

		$field_settings[] = array(
			'field_id' => 'field_1', // This must match a key in Nsm_global_variables_upd::tabs()
			'field_type' => 'nsm_global_variables',
			'field_label' => 'NSM Global Variables Fieldtype',
			'field_instructions' => '',
			'field_required' => '',
			'field_data' => '',
			'field_list_items' => '',
