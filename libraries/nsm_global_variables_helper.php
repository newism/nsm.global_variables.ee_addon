 ...
 * $this->EE->nsm_global_variables_helper->addCSS('custom_field.css');
 * 
 * # Load the JS for the iframe
 * $this->EE->nsm_global_variables_helper->addJS('custom_field.js');
 * $this->EE->nsm_global_variables_helper->addJS('../lib/jquery.cookie.js');
 * 
...
class Nsm_global_variables_helper
{
